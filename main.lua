...
function _init()
  ...
  State = {
    ...
    persist = { debt = nil, credits = 0 },
    next_seed = (os and os.time and os.time() or 20260704) % 100000,
  }
  State.persist.debt = State.defs.economy.debt_start
